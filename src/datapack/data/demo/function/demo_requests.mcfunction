...
\nThe fake player demo function can be used to ensure entities with these scores exist to be resolved.\
",with:[{translate:"essentials.scoreboard.playerid",fallback:"Player ID"}],color:gold}]
...
function essentials:request/store_request with storage essentials:teleport new_request
data modify storage essentials:teleport new_request set value {target_id:1,source_id:9,tp_type:"here"}
function essentials:request/store_request with storage essentials:teleport new_request
data modify storage essentials:teleport new_request set value {target_id:1,source_id:6,tp_type:"here"}
function essentials:request/store_request with storage essentials:teleport new_request
data modify storage essentials:teleport new_request set value {target_id:1,source_id:10,tp_type:"here"}
function essentials:request/store_request with storage essentials:teleport new_request
data modify storage essentials:teleport new_request set value {target_id:1,source_id:10,tp_type:"to"}
function essentials:request/store_request with storage essentials:teleport new_request