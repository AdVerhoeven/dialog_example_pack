...
tellraw @s [{text: "You can test the player selection dialog using"},{text: "/function essentials:player/start", click_event:{action:"run_command",command:"/function essentials:dialog/start"}}]
