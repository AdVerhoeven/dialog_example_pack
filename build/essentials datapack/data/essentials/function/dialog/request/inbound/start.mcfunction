...
execute unless data storage essentials:teleport dialog_actions[0] run tellraw @s [{translate: "essentials.request.inbound.no_requests", fallback: "No incoming teleport requests found!", color: "red"}]
