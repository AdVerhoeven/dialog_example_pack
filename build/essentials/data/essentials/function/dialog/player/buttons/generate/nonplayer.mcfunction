data modify storage essentials:pretty self.label set value [{player: {}}, {text: " "}, {text: "@CustomName"}]
...
data remove storage essentials:pretty command_helper
data modify storage essentials:pretty players append from storage essentials:pretty self
data remove storage essentials:pretty self
